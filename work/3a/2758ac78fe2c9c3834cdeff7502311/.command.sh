...
rocrate_generator.py \
    ...
    --grade 'silver' \
    --blob-path 'silver-skeleton/20260727-mighty-guppy-74d0-silver' \
    ...
    --source-path '/Users/benedictcarling/Documents/GitHub/lbf-upload/bronze-to-silver-skeleton/work/e4/a121053df3e1f0651ce5e9cdad138a/20260727-mighty-guppy-74d0' \
